...
4. For run persistence, publication, retrieval, or comparison work, read [docs/shared-results-system-spec.md](docs/shared-results-system-spec.md), [docs/serving-and-benchmarking-policy.md](docs/serving-and-benchmarking-policy.md), and [docs/run-history.md](docs/run-history.md).
...
[docs/shared-results-system-spec.md](docs/shared-results-system-spec.md) and
