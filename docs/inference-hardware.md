...
| GTX 1080 Ti | Present; older-generation candidate | Targeted utility and economics experiment, not an assumed serving tier | Decide whether it has a practical role using a dedicated throughput, power, latency, and task-quality evaluation. |
